...
import NouveauBonCommandeVente from "../views/vente/NouveauBonCommandeVente.vue"
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/ventes/bon-commande/nouveau", name: "nouveau-bon-commande-vente", component: NouveauBonCommandeVente },
