  ...
  <div class="page-container">
    ...
    <div v-else class="content-wrapper">
      ...
      <div class="page-header fade-in" style="animation-delay: 0.1s">
        <div>
          <h1 class="page-title">Bons de Commande Vente</h1>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr v-else v-for="bc in filteredBonCommandes" :key="bc.id" class="table-row">
                ...
                <td class="font-medium">{{ bc.client }}</td>
...
import { Plus, Eye, Check, Printer, Search } from 'lucide-vue-next'
...
const filteredBonCommandes = computed(() => {
  return bonCommandes.value.filter(bc => {
    ...
    const matchClient = !selectedClient.value || bc.client === selectedClient.value
